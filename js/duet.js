...
function ($) {
    ...
    function t() {
        ...
        }), $(".active-link").removeClass("active-link"), $('a[href="' + e + '"]').addClass("active-link"), Waypoint.destroyAll();
        var t = 0;
            ...
            e.append('<div class="gallery__wrap"></div>'), e.children("img").each(function () {
                ...
                if ("1" === n) {
                    ...
                    var t = new Waypoint({
                            ...
                            handler: function (t) {
                                "down" === t && e.children(".gallery__wrap").trigger("stop.owl.autoplay"), "up" === t && e.children(".gallery__wrap").trigger("play.owl.autoplay")
                            },
                            offset: "-100%"
                        }),
                        s = new Waypoint({
                            element: document.getElementById(i),
                            handler: function (t) {
                                "down" === t && e.children(".gallery__wrap").trigger("play.owl.autoplay"), "up" === t && e.children(".gallery__wrap").trigger("stop.owl.autoplay")
                            },
                            offset: "100%"
                        })
	...
	$("body").hasClass("ajax-loading") && $(document).on("click", "a", function (t) {
        t.preventDefault();
	...
	$(document).on("click", ".menu--list-item-link", function () {
	...
	$(document).on("submit", "#contact-form", function (t) {
        ...
        "" === e.val() && e.closest(".contact-form__item").addClass("contact-form__item--error"), "" === i.val() && i.closest(".contact-form__item").addClass("contact-form__item--error"), "" === n.val() && n.closest(".contact-form__item").addClass("contact-form__item--error"), "" !== e.val() && "" !== i.val() && "" !== n.val() && 0 === s.val().length || t.preventDefault()
	})
